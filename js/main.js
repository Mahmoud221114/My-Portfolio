...
// SKILLS
let skillContent = document.querySelectorAll(".skill");
let skillHeader = document.querySelectorAll(".skills_header");
let skillContentArr = Array.from(skillContent);
let skillHeaderArr = Array.from(skillHeader);
